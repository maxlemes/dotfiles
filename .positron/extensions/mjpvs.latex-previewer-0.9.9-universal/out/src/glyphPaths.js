...
exports.getGlyphPaths = void 0;
function getGlyphPaths(pageSource, documentFonts, glyphPaths) {
    let pageGlyphs = [];
    pageSource.pageFonts.forEach((pageFont) => {
...
exports.getGlyphPaths = getGlyphPaths;
//# sourceMappingURL=glyphPaths.js.map