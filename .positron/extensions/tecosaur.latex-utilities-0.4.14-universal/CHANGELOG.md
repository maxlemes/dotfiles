...
-   Live snippets are now a bit better again (see [#42](https://github.com/tecosaur/LaTeX-Utilities/issues/42))
...
-   Fixed [#17](https://github.com/tecosaur/LaTeX-Utilities/issues/17) (cursor moving backwards too far with some live snippets)
